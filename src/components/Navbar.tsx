      ...
      <div className="container px-4 mx-auto relative text-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            ...
            <span className="text-xl tracking-tight">Dotly</span>
          </div>
          ...
          <div className="hidden lg:flex justify-center space-x-12 item-center">
            <Link to="/login" className="py-2 px-3 border rounded-md">Log in</Link>
            <Link to="/login" className="py-2 px-3 border rounded-md bg-gradient-to-r from-orange-500 to-orange-800">Sign up</Link>
          </div>
